...
define('MENUS_HOME', '홈');
define('MENUS_ADMIN', '관리');
define('MENUS_ACCOUNT', '계정');
define('MENUS_ACCOUNT_EDIT', '계정 수정');
define('MENUS_ACCOUNT_LOGIN', '로그인');
define('MENUS_ACCOUNT_LOGOUT', '로그아웃');
define('MENUS_ACCOUNT_REGISTER', '가입하기');
define('MENUS_ACCOUNT_MESSAGES', '메시지');
define('MENUS_ACCOUNT_NOTIFICATIONS', '알림');
define('MENUS_ACCOUNT_TOOLBAR', '도구 모음');
