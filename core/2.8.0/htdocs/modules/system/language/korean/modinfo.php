...
//2.8.0
define('_MI_SYSTEM_PREFERENCE_ACTIVE_LANGUAGES', '언어 관리 사용');
define('_MI_SYSTEM_PREFERENCE_ACTIVE_LANGUAGES_DESC', '로캘 레지스트리, 언어 팩, 상태 점검 및 사이트 번역 재정의를 관리합니다.');
define('_MI_SYSTEM_BNAME14', '언어 전환기');
