...
define('_ELAPSE', '%s 이전');
define('_TIMEFORMAT_DESC', "사용 가능한 형식: \"s\" - " . _SHORTDATESTRING . "; \"m\" - " . _MEDIUMDATESTRING . "; \"l\" - " . _DATESTRING . ';<br>' . "\"c\" 또는 \"custom\" - 표시할 기간에 따라 형식 결정; \"e\" - 경과 시간; \"mysql\" - Y-m-d H:i:s;<br>" . "직접 지정한 문자열 - <a href=\"https://php.net/manual/ko/function.date.php\" rel=\"external\">PHP 매뉴얼</a>을 참조하십시오.");
...
class XoopsLocal extends XoopsLocalAbstract
{
    ...
    private const CURRENCY = ['locale' => 'ko_KR', 'code' => 'KRW', 'symbol' => '₩',  'decimals' => 0, 'decSep' => '.', 'thouSep' => ',', 'pattern' => '%2$s%1$s'];
