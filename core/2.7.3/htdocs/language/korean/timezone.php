...
//%%%%%     Time Zone   %%%%
define('_TZ_GMTM12', '(GMT-12:00) 에니웨톡, 콰잘레인');
define('_TZ_GMTM11', '(GMT-11:00) 미드웨이 섬, 사모아');
...
define('_TZ_GMTM2', '(GMT-2:00) 중부 대서양');
define('_TZ_GMTM1', '(GMT-1:00) 아조레스 제도, 카보베르데 제도');
define('_TZ_GMT0', '(GMT) 그리니치 표준시, 런던, 더블린, 리스본, 카사블랑카, 몬로비아');
define('_TZ_GMTP1', '(GMT+1:00) 암스테르담, 베를린, 로마, 코펜하겐, 브뤼셀, 마드리드, 파리');
define('_TZ_GMTP2', '(GMT+2:00) 아테네, 이스탄불, 민스크, 헬싱키, 예루살렘, 남아프리카');
...
define('_TZ_GMTP5', '(GMT+5:00) 에카테린부르크, 이슬라마바드, 카라치, 타슈켄트');
define('_TZ_GMTP55', '(GMT+5:30) 뭄바이, 콜카타, 첸나이, 뉴델리');
define('_TZ_GMTP6', '(GMT+6:00) 알마티, 다카, 콜롬보');
define('_TZ_GMTP7', '(GMT+7:00) 방콕, 하노이, 자카르타');
define('_TZ_GMTP8', '(GMT+8:00) 베이징, 퍼스, 싱가포르, 홍콩, 우루무치, 타이베이');
define('_TZ_GMTP9', '(GMT+9:00) 도쿄, 서울, 오사카, 삿포로, 야쿠츠크');
define('_TZ_GMTP95', '(GMT+9:30) 애들레이드, 다윈');
define('_TZ_GMTP10', '(GMT+10:00) 브리즈번, 캔버라, 멜버른, 시드니, 괌, 블라디오스토크');
define('_TZ_GMTP11', '(GMT+11:00) 마가단, 솔로몬 제도, 뉴 칼레도니아');
define('_TZ_GMTP12', '(GMT+12:00) 오클랜드, 웰링턴, 피지, 캄차카, 마샬아일랜드');
